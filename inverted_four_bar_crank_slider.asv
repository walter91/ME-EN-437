function [theta4, r3, xp, yp] = inverted_four_bar_crank_slider(angles, lengths, p, options)
...
[unknowns] = fsolve(@inverted_four_bar_crank_slider_equations, guess, [], angles, lengths);
...
xp = lengths(2)*cosd(angles(2)) + p(1)*cosd(theta3);
